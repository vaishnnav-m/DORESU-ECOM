...
function SignupForm() {
  ...
  return (
    ...
    >
      ...
      {isSuccess && <span className="text-green-500">Signup successful!</span>}
      <div className="bg-[#bbbbbb] h-[1px] relative my-1">
        <span className="text-[#8A8A8A] font-semibold absolute left-1/2 -translate-y-1/2 bg-white p-2">
          OR
        </span>
      </div>

      <button className="w-full h-[55px] rounded-lg border text-[24px] text-[#737373] flex justify-center items-center gap-5 shadow">
        <img src={Google} alt="" />
        <span>Google</span>
      </button>
    </form>
